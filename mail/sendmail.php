...
if(isset($_POST["send"])){
	...
	$mail->IsSMTP(); 
	$mail->Host = 'ssl://smtp.gmail.com'; //Hostname of the mail server
	$mail->Port = 465; //Port of the SMTP like to be 25, 80, 465 or 587
	$mail->SMTPAuth = true; //Whether to use SMTP authentication
	$mail->Username = 'sonia@xantatech.com'; //Username for SMTP authentication any valid email created in your domain
	$mail->Password ='sonia12345'; //Password for SMTP authentication
